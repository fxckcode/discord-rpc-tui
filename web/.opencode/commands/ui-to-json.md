...
- Work from the example provided; you must deliver the prompt in .json format and handle everything by sections and blocks within each section. Review the level of detail in the example and deliver accordingly. Save it to .cursor/ui-to-json.
